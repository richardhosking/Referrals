...
class ReferrersControllerTest < ActionController::TestCase
  ...
  test "should create referrer" do
    assert_difference('Referrer.count') do
      post :create, referrer: { FAX: @referrer.FAX, email: @referrer.email, name: @referrer.name, phone: @referrer.phone, provider_number: @referrer.provider_number }
    end
  ...
  test "should update referrer" do
    patch :update, id: @referrer, referrer: { FAX: @referrer.FAX, email: @referrer.email, name: @referrer.name, phone: @referrer.phone, provider_number: @referrer.provider_number }
    assert_redirected_to referrer_path(assigns(:referrer))
  end
