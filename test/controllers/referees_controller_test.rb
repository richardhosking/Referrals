...
class RefereesControllerTest < ActionController::TestCase
  ...
  test "should create referee" do
    assert_difference('Referee.count') do
      post :create, referee: { FAX: @referee.FAX, email: @referee.email, name: @referee.name, phone: @referee.phone }
    end
  ...
  test "should update referee" do
    patch :update, id: @referee, referee: { FAX: @referee.FAX, email: @referee.email, name: @referee.name, phone: @referee.phone }
    assert_redirected_to referee_path(assigns(:referee))
  end
