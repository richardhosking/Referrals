...
class ClinicsControllerTest < ActionController::TestCase
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post :create, clinic: { FAX: @clinic.FAX, email: @clinic.email, name: @clinic.name, phone: @clinic.phone }
    end
  ...
  test "should update clinic" do
    patch :update, id: @clinic, clinic: { FAX: @clinic.FAX, email: @clinic.email, name: @clinic.name, phone: @clinic.phone }
    assert_redirected_to clinic_path(assigns(:clinic))
  end
